...
`npm test` passed on 2026-08-26 with 527 cases (523 passed and four explicit
...
|---|---|---|---|
| Independent runtime | Boundary and independence guards; no Paperclip package or schema dependency; exact source candidate `e4bf9af33a88d7bd4f0d0c43c71cc01e0a845f4a` passed the full GitHub Actions qualification | Publish and repeat against the immutable six-image release candidate | Source candidate qualified; release pending |
